@props(['icon', 'title', 'subtitle', 'color' => 'blue'])
...
<div class="group cursor-pointer bg-white dark:bg-slate-800 p-4 sm:p-5 lg:p-6 rounded-xl sm:rounded-2xl border border-primary/10 hover:border-primary hover:shadow-xl hover:shadow-primary/5 transition-all relative overflow-hidden text-center sm:text-left">
