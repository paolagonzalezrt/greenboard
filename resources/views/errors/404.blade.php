...
<div class="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20 min-h-[60vh] w-full px-4 py-16 fade-in">
    ...
    <div class="text-center lg:text-left max-w-md">
        <p class="text-7xl font-black text-primary mb-4 leading-none">404</p>
        <h1 class="text-3xl lg:text-4xl font-black text-slate-900 dark:text-slate-100 mb-4 leading-tight">
            Oops! This leaf fell<br>from the tree
        </h1>
        <p class="text-slate-500 dark:text-slate-400 text-base mb-8 leading-relaxed">
            The page you are looking for doesn't exist or has been moved to a more sustainable location.
        </p>
        <a href="{{ route('home') }}"
           class="inline-flex items-center gap-2 bg-primary text-slate-900 font-bold px-6 py-3 rounded-full hover:brightness-105 transition-all active:scale-95 shadow-lg shadow-primary/20">
