...
<div class="organic-shape bg-primary/20 dark:bg-primary/10 absolute -inset-4 blur-3xl"></div>
...
<div class="max-w-7xl mx-auto px-0 relative z-10">
...
<!-- Card 1 -->
<div class="group relative p-10 rounded-3xl bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
...
<div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href="{{ auth()->check() ? route('dashboard') : route('home') }}" class="w-full max-w-[240px] sm:w-auto bg-transparent text-slate-900 dark:text-white border border-slate-300 dark:border-slate-600 px-6 py-2.5 rounded-full font-bold text-sm hover:bg-slate-100 dark:hover:bg-slate-800 transition-all text-center">
